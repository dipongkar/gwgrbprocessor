...
shutil.copytree(script + '/runs/CBC/GRB' + grb + '/GRB' + grb + \
               '/post_processing/output', '/home/' + user + \
               '/public_html/grb/online/' + run + '/GRB' + grb)
